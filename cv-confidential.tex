...
\begin{itemize}
  \item \bibentry{lee2024chomi} -- \emph{Under review with ICSE'25 (1 Acceptance, 2 Weak Acceptance)}
  \item \bibentry{lee2024unseen} -- \emph{Under review with Neurips'24}
  \item \bibentry{lee2024discover} -- \emph{Under review with Neurips'24}
  \item \bibentry{Lee:2021ul} -- \emph{Under review with Science of Computer Programming}
\end{itemize}
