...
\begin{itemize}[leftmargin=2cm]
  ...
  \item[JSS'21] \bibentry{leeObservationbasedApproximateDependency2021a}
  \item[JSS'20] \bibentry{leeEvaluatingLexicalApproximation2020a}
\end{itemize}

\textbf{Refereed Conference Publications}\vspace{-4pt}
\begin{itemize}[leftmargin=2cm]
  \item[ICSE'25] \bibentry{lee2025accounting}
  \item[ICSE'24] \bibentry{liyanageExtrapolatingCoverageRate2024a} \\ (*\emph{Co-first authors with equal contribution})
  \item[FSE'23] \bibentry{leeStatisticalReachabilityAnalysis2023a}
...
\begin{itemize}[leftmargin=2cm]
  \item[] \bibentry{leeStructureawareResidualRisk2025} -- \emph{Under review with ISSTA'25}
  \item[] \bibentry{cleverest} -- \emph{Under review with FSE'25} \\ (*\emph{Co-first authors with equal contribution})
  \item[] \bibentry{leeHowMuchUnseen2024a} -- \emph{Under review with ICLR'25, Initial review score: 7.33/10 (8:=accept, 8, 6:=weak accept)}
\end{itemize}

\textbf{Invited Articles}\vspace{-4pt}
\begin{itemize}[leftmargin=2cm]
  \item[GI'20] \bibentry{langdonGeneticImprovementICSE2020a}
\end{itemize}

\textbf{Refereed Workshop Publications}\vspace{-4pt}
\begin{itemize}[leftmargin=2cm]
  \item[ICST'21] \bibentry{ohEffectivelySamplingHigher2021a}
  \item[ICSE'20] \bibentry{leeScalableApproximateProgram2020a}
  \item[KCC'19] \bibentry{anPYGGIPythonGeneral2017}
  \item[ICSE'18] \bibentry{leeMOBSMultiOperatorObservationBased2018a}
  \item[SBSE'17] \bibentry{leeHyperheuristicObservationBased2017a}
  \item[SBSE'16] \bibentry{sohnAmortisedDeepParameter2016a}
\end{itemize}

% \textbf{Preprints}\vspace{-4pt}
% \begin{itemize}
%   \item \bibentry{leeStructureawareResidualRisk2025} -- \emph{Under review with ISSTA'25}
%   \item \bibentry{leeCleverest2025} -- \emph{Under review with FSE'25} \\ (*\emph{Co-first authors with equal contribution})
%   \item \bibentry{leeHowMuchUnseen2024} -- \emph{Under review with ICLR'25}
% \end{itemize}
...
% \begin{itemize}
%   \item \bibentry{leeChaomi2024}
%   % \item \bibentry{liyanageExtrapolatingCoverageRate2024} \\ (*\emph{Co-first authors with equal contribution})
%   \item \bibentry{leeStatisticalReachabilityAnalysis2023}
%   \item \bibentry{ohEffectivelySamplingHigher2021}
%   \item \bibentry{leeScalableApproximateProgram2020}
%   \item \bibentry{leeClassifyingFalsePositive2019a}
%   \item \bibentry{leeMOADModelingObservationBased2019a}
%   \item \bibentry{leeHyperheuristicObservationBased2017}
%   \item \bibentry{anPYGGIPythonGeneral2017}
%   \item \bibentry{sohnAmortisedDeepParameter2016}
% \end{itemize}

% \textbf{Peer-Reviewed Journal Articles}\vspace{-4pt}

% \begin{itemize}
%   \item \bibentry{leeCausalProgramDependence2025}
%   \item \bibentry{leeObservationbasedApproximateDependency2021}
%   \item \bibentry{leeEvaluatingLexicalApproximation2020}
% \end{itemize}

% \textbf{Posters \& Technical Reports}\vspace{-4pt}
% \begin{itemize}
%   \item \bibentry{leeCausalProgramDependence2021}
%   \item \bibentry{leeMOBSMultiOperatorObservationBased2018}
%   \item \bibentry{leeHyperheuristicObservationBased2017}
% \end{itemize}

% \textbf{Software Engineering Notes}\vspace{-4pt}
% \begin{itemize}
%   \item \bibentry{langdonGeneticImprovementICSE2020}
% \end{itemize}
