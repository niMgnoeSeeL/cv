...
The overarching objective of my research is to \emph{ensure software correctness in complex and critical modern software systems} through \textbf{scalable program analysis} and \textbf{reliable software testing}. To achieve this, I \textbf{leverage interdisciplinary statistical methods}, such as \emph{causal inference, biostatistics, and machine learning}, to analyze the dynamic behavior of software in operational environments. My work has been published in top-tier software engineering venues, including ICSE, FSE, and JSS, and I have served as a program committee member for leading conferences, such as FSE, ASE, and ISSTA.
...
\begin{itemize}[leftmargin=2cm]
  ...
  \item[] \bibentry{liuCanLLMGenerate2025} -- \emph{Under review with FSE'25} \\ (*\emph{Co-first authors with equal contribution})
  \item[] \bibentry{leeHowMuchUnseen2024} -- \emph{Under review with ICLR'25, Initial review score: [8, 8, 6] (8: Accept, 6: Weak Accept)}
\end{itemize}
...
\begin{itemize}
  \item Program committee: (Main Track) CauSE'25, ASE'24, ISSTA'24, FUZZING'24, SCAM'24, ASE'23 / (Artifact Evaluation Track) ISSTA'24, ECOOP'24, USENIX Security'24, ICSE'24, ISSTA'23, ICSME'22, ICSME'21 / (Student Research Competition Track) FSE'24 / (Tool Demonstration Track) ASE'24
