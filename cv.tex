...
\begin{itemize}
  ...
  \item \bibentry{Lee:2021ul} -- \emph{Under review}
\end{itemize}
...
\begin{itemize}
  ...
  \item Program committee: (Main Track) ISSTA'24, FUZZING'24, SCAM'24, ASE'23 / (Artifact Evaluation Track) ISSTA'24, ECOOP'24, USENIX Security'24, ICSE'24, ISSTA'23, ICSME'22, ICSME'21 / (Student Research Competition Track) FSE'24 / (Tool Demonstration Track) ASE'24
...
\begin{itemize}
  \item \emph{On the Surprising Efficiency, Scalability, and Predictability of Greybox Fuzzing} \\
  Fuzzing and Software Security Summer School @ National University of Singapore, 2024
  \begin{itemize}[label={-}, leftmargin=0.5cm, topsep=0pt, itemsep=0pt]
    \item \emph{Responsible for a part of Dr. Marcel Böhme's lecture and live coding session on the predictability of fuzzing.}
  \end{itemize}
