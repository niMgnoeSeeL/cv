...
My research interest lies in program analysis and software testing. The overarching objective of my research is \textbf{making program analysis scalable} by addressing the challenges associated with the scale and complexity of software systems and \textbf{achieving practical software testing in real-world scenarios}. I \textbf{utilize statistical methods to analyze dynamic information from program execution}, facilitating the reasoning of a program's semantic properties and addressing empirical challenges in software testing.
...
\begin{itemize}
  \item \bibentry{Liyanage:2024ab} \\ (*\emph{Co-first authors with equal contribution})
...
\begin{itemize}
  ...
  \item Reviewer: TOSEM'24, TSE'24, IST'24, ASE'24, TOSEM'22, JSS'21, JSS'20  / (External) FSE'24, ECOOP'24, ICSE'23, ISSTA'23
\end{itemize}
